...
public class PersonalDataController {
    ...
    public Map<Integer, List<DevelopmentAction>> getDevelopmentActions(@PathVariable("collaboratorId") String collaboratorId, @PathVariable("year") int year, @PathVariable("locale") String locale) throws Exception {
        ...
        Set<DevelopmentAction> developmentActions = mydevDevelopmentActions.findBySubjectAndDevelopmentYear(collaboratorId, year, locale);
        ...
        List<DevelopmentAction> sortDevelopmentAction = developmentActions.stream()
