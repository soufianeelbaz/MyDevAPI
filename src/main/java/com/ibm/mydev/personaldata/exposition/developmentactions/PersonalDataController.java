...
import com.ibm.mydev.personaldata.domain.developmentactions.MyDevDevelopmentActionRepresentation;
...
public class PersonalDataController {
    ...
    @ResponseBody
    public MyDevDevelopmentActionRepresentation getDevelopmentActions(@PathVariable("collaboratorId") String collaboratorId, @PathVariable("year") int year, @PathVariable("locale") String locale) throws Exception {
        ...
        return new MyDevDevelopmentActionRepresentation(
                developmentActions.getStatusCode(),
                developmentActions.getStatusMessage(),
                groupingDevelopmentAction
        );
    }
}
